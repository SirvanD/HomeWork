...
while (booksIndex < books.length){
    if (books[booksIndex].read){
        console.log(`You already read "${books[booksIndex].title}" by ${books[booksIndex].author}`)
    }else {
        console.log(`You still need to read "${books[booksIndex].title}" by ${books[booksIndex].author}`)
    }
