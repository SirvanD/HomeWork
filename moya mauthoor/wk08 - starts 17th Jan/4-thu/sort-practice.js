...
horses.sort((horse1, horse2) => horse1.yearOfBirth > horse2.yearOfBirth ? -1 : 1);
console.log(horses);
...
items.sort((item1, item2) => item1.full_price - item2.full_price);
...
var products = [
 ...
 products.sort((product1, product2) => product1[1] > product2[1] ? -1 : 1 )
