...
const ageByOrder = horses.sort((a, b) => {
...
console.log("ageByOrder", ageByOrder);
...
const priceByOrder = items.sort((a, b) => {
...
console.log("priceByOrder", priceByOrder);

// sort items by name in the ascending

const nameOrder = items.sort((a, b) => {
  if (a.name < b.name) {
    return -1;
  } else {
    return 1;
...
const productByName = products.sort((a, b) => {
  if (a[1] < b[1]) {
    return -1;
  } else {
    return 1;
