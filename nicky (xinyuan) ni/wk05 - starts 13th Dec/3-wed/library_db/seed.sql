...
INSERT INTO authors(name, nationality, birth_year) VALUES ('Nicky Ni', 'China', 1993);
...
-- Nicky Ni
INSERT INTO books(title, publication_date, author_id) VALUES ('第一本书', 2022, 9);
INSERT INTO books(title, publication_date, author_id) VALUES ('第二本书', 2023, 9);
...
SELECT * FROM books WHERE publication_date > 2000;

INSERT INTO authors(name, nationality, birth_year) VALUES ('Nicky Ni', 'China', 1993);
INSERT INTO books(title, publication_date, author_id) VALUES ('第一本书', 2022, 9);
INSERT INTO books(title, publication_date, author_id) VALUES ('第二本书', 2023, 9);

UPDATE books SET title = 'My first book' WHERE title = '第一本书';

DELETE FROM books WHERE author_id = 9;

DELETE FROM authors WHERE  name = 'Nicky Ni';